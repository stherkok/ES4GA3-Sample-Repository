...
library(spgwr) # package for estimating gwr models
library(tidyverse) # packages for data manipulation, analysis, and visualization (includes `ggplot2`)
...
Model income and opioid usage in Kentucky:
```{r model-income, echo=FALSE}
model1 <- lm(formula = per_person ~ income, data = KY_AVG_Per)
summary (model1)
```
...
Model educational attainment and opioid usage in Kentucky
```{r model-education, echo=FALSE}
